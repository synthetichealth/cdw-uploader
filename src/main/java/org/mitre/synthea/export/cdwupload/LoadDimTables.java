...
public class LoadDimTables {
	...
	public static void load(Connection cn, String dir, Boolean batchMode) throws Exception{	
		...
		TableBatch.load(dir+"location.csv",cn,"Dim.Location",batchMode," ( LocationSID,LocationName) ",F.s,F.g);
		...
		TableBatch.load(dir + "orderableitem.csv", cn, "Dim.OrderableItem",  false,
		...
		TableBatch.load(dir + "sta3n.csv", cn, "Dim.Sta3n", batchMode,"(Sta3n,Sta3nName,TimeZone)", F.s,F.g,F.s );
